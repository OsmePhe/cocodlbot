      ...
      stream.on('tweet', function (tweet) {
          ...
          T.get('statuses/show', { id: tweet.in_reply_to_status_id_str, include_rts: true}).then(res => {
            ...
            if(fileNameWithoutExt) {
              T.post('statuses/update',{status: "@" + tweet.user.screen_name + ' ' +'http://localhost:5000/home/tweet/'+fileNameWithoutExt, in_reply_to_status_id: tweet.id_str}, responseCallback);
            }
